...
@interface BSNSCXMLDictionaryParser () <NSXMLParserDelegate>
...
@implementation BSNSCXMLDictionaryParser

+ (BSNSCXMLDictionaryParser *)sharedInstance
{
    static dispatch_once_t once;
    static BSNSCXMLDictionaryParser *sharedInstance;
    dispatch_once(&once, ^{
        
        sharedInstance = [[BSNSCXMLDictionaryParser alloc] init];
    });
...
{
    BSNSCXMLDictionaryParser *copy = [[[self class] allocWithZone:zone] init];
...
{
    return [[[BSNSCXMLDictionaryParser sharedInstance] copy] dictionaryWithParser:parser];
}

+ (NSDictionary *)dictionaryWithXMLData:(NSData *)data
{
    return [[[BSNSCXMLDictionaryParser sharedInstance] copy] dictionaryWithData:data];
}

+ (NSDictionary *)dictionaryWithXMLString:(NSString *)string
{
    return [[[BSNSCXMLDictionaryParser sharedInstance] copy] dictionaryWithString:string];
}

+ (NSDictionary *)dictionaryWithXMLFile:(NSString *)path
{
    return [[[BSNSCXMLDictionaryParser sharedInstance] copy] dictionaryWithFile:path];
}
...
- (NSString *)innerXML
{
    ...
    {
        [nodes addObject:[BSNSCXMLDictionaryParser XMLStringForNode:childNodes[key] withNodeName:key]];
    }
...
- (NSString *)XMLString
{
    ...
    {
        return [BSNSCXMLDictionaryParser XMLStringForNode:self withNodeName:[self nodeName] ?: @"root"];
    }
}
